...
def group_numbers_into_fives(input_string):
    ...
    # Split the string into groups of 5, add a comma and space after each number, and a period at the end
    groups_of_fives = [', '.join(input_string[i:i+5]) + '.' for i in range(0, len(input_string), 5)]
